...
<?php
    ...
    ?>
<div class="alert__message success container" style="text-align: center;">
  <p>
...
<?php elseif(isset($_SESSION['edit-category-succcess'])) :
    ?>
<div class="alert__message success container" style="text-align: center;">
  <p>
  <?= $_SESSION['edit-category-succcess'];
  unset($_SESSION['edit-category-succcess']);
  ?>
</p>
</div>
...
<?php endif ?>
  ...
  <div class="container dashboard__container">
       ...
       <?php if(isset($_SESSION['user_is_admin'])): ?>
        ...
        <li>
          <a href="manage-categories.php"
            class="active"><i class="uil uil-list-ul"></i>
    ...
    <main>
      ...
      <?php else : ?>
        <div class="alert__message error "><?="No categories available"?></div>
        <?php endif?>
    </main>
  </div>
</section>
